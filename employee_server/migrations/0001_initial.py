# Generated by Django 2.1.4 on 2018-12-19 10:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_date', models.DateField(default=None)),
                ('salary', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True)),
                ('low_manager', models.ManyToManyField(related_name='low_level_manager', to='employee_server.LowLevelManager')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='seniormanager', related_query_name='seniormanager', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_date', models.DateField(default=None)),
                ('salary', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True)),
                ('senior_manager', models.ManyToManyField(related_name='senior_manager', to='employee_server.SeniorManager')),
        ...
        migrations.AddField(
            ...
            name='specialist',
            field=models.ManyToManyField(related_name='specialist', to='employee_server.Specialist'),
        ),
        migrations.AddField(
            model_name='lowlevelmanager',
            name='user',
