# Generated by Django 2.1.4 on 2018-12-24 09:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Subdivision',
            fields=[
                ('id', models.CharField(help_text='Forsquare ID of the subdivision.', max_length=32, primary_key=True, serialize=False, unique=True, verbose_name='ID')),
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, help_text='Parent subdivision.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='employee_server.Subdivision', verbose_name='Parent subdivision')),
            ],
            options={
