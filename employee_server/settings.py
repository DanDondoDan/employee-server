"""
Django settings for employee_server project.
...
DEBUG = ENV.DEBUG
TOKEN_LIFETIME = ENV.TOKEN_DURATION_HOURS
TOKEN_LIFETIME = 24
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'employee_server.wsgi.application'
...
AUTH_USER_MODEL = 'employee_server.User'
